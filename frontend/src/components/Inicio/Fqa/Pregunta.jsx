...
const FaqComponent = () => {
  ...
  <section class="mb-32">
    ...
    <div class="grid gap-6 lg:grid-cols-3">
      <div class="mb-6 md:mb-8 lg:mb-12  group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400  hover:ring-sky-800">
        <p class="mb-4 font-bold group-hover:text-white ">¿Qué aporta Prop Token?</p>
        <p class="text-neutral-500 dark:text-neutral-300 text-justify ... group-hover:text-white">
      ...
      <div class="mb-6 md:mb-8 lg:mb-12 group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400 hover:ring-sky-800">
        <p class="mb-4 font-bold  group-hover:text-white">¿Cómo es el proceso de inversión?</p>
        <p class="text-neutral-500 dark:text-neutral-300 text-justify ...  group-hover:text-white">
      ...
      <div class="mb-6 md:mb-8 lg:mb-12 group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400 hover:ring-sky-800">
        <p class="mb-4 font-bold  group-hover:text-white">
          ¿Cuanto tarda?
        </p>
        <p class="text-neutral-500 dark:text-neutral-300 text-justify ...  group-hover:text-white">
      ...
      <div class="mb-6 md:mb-8 lg:mb-12 group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400 hover:ring-sky-800">
        <p class="mb-4 font-bold  group-hover:text-white">¿Es legal?</p>
        <p class="text-neutral-500 dark:text-neutral-300 text-justify ...  group-hover:text-white">
