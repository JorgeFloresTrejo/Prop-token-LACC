    ...
    <div className=" my-24 mx-auto md:px-6">
      ...
      <section className="mb-32">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="mb-6 md:mb-8 lg:mb-12  group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400  hover:ring-sky-800">
            <p className="mb-4 font-bold group-hover:text-white ">
              ¿Qué aporta Prop Token?
            </p>
            <p className="text-neutral-500 dark:text-neutral-300 text-justify ... group-hover:text-white">
              PropToken facilita la inversión en el sector inmobiliario
              Salvadoreño. Nuestra misión es darte acceso a invertir en
              oportunidades inmobiliarias seleccionadas por nuestro equipo de
              profesionales, que ofrecen un activo eficiente con la mejor
              relación riesgo / rentabilidad. El inversor obtendrá los
              beneficios en forma de dividendos de la explotación del inmueble
              en el que invierta a través de un préstamo participativo
              tokenizado. La digitalización del préstamo en forma de token
          ...
          <div className="mb-6 md:mb-8 lg:mb-12 group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400 hover:ring-sky-800">
            <p className="mb-4 font-bold  group-hover:text-white">
              ¿Cómo funciona legalmente PropToken?
            </p>
            <p className="text-neutral-500 dark:text-neutral-300 text-justify ...  group-hover:text-white">
          ...
          <div className="mb-6 md:mb-8 lg:mb-12 group rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-blue-400 hover:ring-sky-800">
            <p className="mb-4 font-bold  group-hover:text-white">¿Es legal?</p>
            <p className="text-neutral-500 dark:text-neutral-300 text-justify ...  group-hover:text-white">
